---
name: browser-setup
description: Guide the user through browser automation setup in MAYA
---

Help the user set up browser automation in MAYA.
...
1) Are you using the MAYA desktop app, or the web app?
...
2) If they want the OpenCode Browser path:
   - Tell them where to check in MAYA (Plugins tab) and what "connected" looks like.
