...
export default {
  ...
  "dashboard.maya_host_label": "MAYA server URL",
  "dashboard.maya_host_placeholder": "https://your-server.maya.app",
  "dashboard.maya_host_hint": "Use the URL shared by your MAYA server.",
  "dashboard.maya_host_token_label": "Access token",
  "dashboard.maya_host_token_placeholder": "Paste your token",
  "dashboard.maya_host_token_hint": "Optional. Paste the access token from the server to authenticate.",
  "dashboard.remote_mode_maya_alpha": "MAYA server",
  "dashboard.remote_mode_direct": "Direct (legacy)",
  "dashboard.remote_connection_maya": "MAYA",
  ...
  "session.permission_description": "MAYA is requesting permission to continue.",
  ...
  "commands.name_hint": "This becomes /daily-standup in MAYA.",
  ...
  "skills.install_hint": "Installs OpenPackage packages into the current worker. Skills should land in `.maya/skills`.",
  ...
  "skills.no_skills": "No skills detected in `.maya/skills`, `.claude/skills`, or `~/.agents/skills`.",
  "skills.desktop_required": "Skill management requires the desktop app.",
  "skills.host_only_error": "Skill management requires a local worker or connected MAYA server.",
  ...
  "skills.connect_host_to_load": "Connect an MAYA server to load skills.",
  ...
  "skills.no_opencode_found": "No maya.json found yet. Add a plugin to create one.",
  "skills.no_opencode_workspace": "No maya.json in this worker yet.",
  "skills.failed_parse_opencode": "Failed to parse maya.json",
  "skills.failed_load_opencode": "Failed to load maya.json",
  "skills.failed_load_active": "Failed to load active plugins.",
  "skills.enter_plugin_name": "Enter a plugin package name.",
  "skills.plugin_already_listed": "Plugin already listed in maya.json.",
  "skills.failed_update_opencode": "Failed to update maya.json",
  ...
  // ==================== Plugins ====================
  "plugins.title": "MAYA plugins",
  "plugins.description": "Manage `maya.json` for your project or global MAYA plugins.",
  ...
  "plugins.placeholder": "maya-wakatime",
  "plugins.add_hint": "Add npm package names, e.g. maya-wakatime",

  // ==================== Apps (MCP) ====================
  "mcp.apps_title": "Apps",
  "mcp.apps_subtitle": "Connect your favorite tools so MAYA can use them on your behalf.",
  ...
  "mcp.mcps_title": "Apps",
  "mcp.connect_mcp_hint": "Connect apps to expand what MAYA can do.",
  ...
  "mcp.mcps_label": "Apps",
  "mcp.mcps_description": "Connect apps to expand what MAYA can do.",
  ...
  "mcp.config_locations": "Config can live in maya.json, maya.jsonc, or .maya/maya.json.",
  ...
  "mcp.use_debug_command": "Run maya mcp debug <name> to troubleshoot.",
  ...
  "mcp.auth.reload_notice": "For this to take effect, MAYA needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_blocked": "Reload is paused while a session is running. Stop the run to finish setup.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, MAYA needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize MAYA",
  ...
  "mcp.auth.reauth_cli_hint": "Run: maya mcp auth {server}",
  ...
  "settings.engine_source_description": "PATH uses your installed MAYA (default). Sidecar will use a bundled binary when available.",
  ...
  "settings.updates_description": "Keep MAYA up to date.",
  ...
  "settings.advanced_description": "Reset MAYA local state to retest onboarding.",
  "settings.reset_onboarding": "Reset onboarding",
  "settings.reset_onboarding_description": "Clears MAYA preferences and restarts the app.",
  "settings.reset_app_data": "Reset app data",
  "settings.reset_app_data_description": "More aggressive. Clears MAYA cache + app data.",
  ...
  "settings.reset_confirmation_hint": "Type <span class=\"font-mono\">RESET</span> to confirm. MAYA will restart.",
  "settings.reset_onboarding_warning": "Clears MAYA local preferences and worker onboarding markers.",
  "settings.reset_app_data_warning": "Clears MAYA cache and app data on this device.",
  ...
  "settings.opencode_cache": "MAYA cache",
  ...
  "settings.engine_source_hint": "PATH uses your installed MAYA (default). Sidecar will use a bundled binary when available.",
  ...
  "settings.updates_hint": "Keep MAYA up to date.",
  ...
  "settings.advanced_hint": "Reset MAYA local state to retest onboarding.",
  "settings.reset_onboarding_label": "Reset onboarding",
  "settings.reset_onboarding_hint": "Clears MAYA preferences and restarts the app.",
  "settings.reset_app_data_label": "Reset app data",
  "settings.reset_app_data_hint": "More aggressive. Clears MAYA cache + app data.",
  "settings.reset_requires_hint": "Requires typing RESET and will restart the app.",
  "settings.developer_title": "Developer",
  "settings.opencode_cache_label": "MAYA cache",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "Starting MAYA server...",
  "onboarding.searching_host": "Connecting to MAYA server...",
  ...
  "onboarding.start": "Start MAYA",
  "onboarding.back": "Back",
  "onboarding.advanced_settings": "Advanced settings",
  "onboarding.opencode_engine": "MAYA engine",
  "onboarding.refresh": "Refresh",
  "onboarding.checking_cli": "Checking MAYA CLI...",
  "onboarding.cli_not_found": "MAYA CLI not found.",
  "onboarding.cli_needs_update": "MAYA CLI needs an update for serve.",
  "onboarding.opencode": "MAYA",
  "onboarding.cli_ready": "MAYA CLI ready.",
  "onboarding.cli_version": "MAYA {version}",
  "onboarding.windows_install_instruction": "Install MAYA for Windows, then restart MAYA. Ensure maya.exe is on PATH.",
  "onboarding.install_instruction": "Install MAYA to enable the local server (no terminal required).",
  "onboarding.install": "Install MAYA",
  "onboarding.recheck": "Re-check",
  "onboarding.ready_message": "MAYA is ready to start the local server.",
  ...
  "onboarding.cli_install_commands": "Install MAYA with one of the commands below, then restart MAYA.",
  ...
  "onboarding.fix_migration_hint": "Stops local engine, runs maya db migrate, then retries startup.",
  ...
  "onboarding.connect_description": "Pair with an existing MAYA server (LAN or tunnel).",
  ...
  "onboarding.remote_workspace_title": "Connect to MAYA server",
  "onboarding.remote_workspace_description": "Connect to an MAYA server to access a worker from anywhere.",
  "onboarding.remote_workspace_action": "Connect",
  "onboarding.remote_workspace_card_title": "Connect a remote worker",
  "onboarding.remote_workspace_card_description": "Connect to an MAYA server to access a shared worker.",
  "onboarding.advanced_maya_host": "MAYA server",
  "onboarding.advanced_maya_hint": "Use a server URL and access token for shared access.",
  "onboarding.advanced_opencode_direct": "Advanced: MAYA direct",
  "onboarding.advanced_opencode_hint": "Connect straight to an MAYA engine when no server is available.",
  "onboarding.welcome_title": "How would you like to run MAYA today?",
  "onboarding.run_local": "Run locally",
  "onboarding.run_local_description": "MAYA runs MAYA locally and keeps your work private.",
  "onboarding.worker_control_label": "Worker Control",
  "onboarding.isolation_label": "Isolation",
  "onboarding.isolation_hint": "Runs in a secure Docker sandbox with access to only this folder.",
  "onboarding.full_control_label": "Full Control",
  "onboarding.full_control_hint": "Runs directly on your host system with full access.",
  ...
  "onboarding.default_workspace_path": "~/MAYA/Worker",
  ...
  "status.installing_opencode": "Installing MAYA",
  "status.repairing_migration": "Repairing migration",
  "status.disconnecting": "Disconnecting",

  // ==================== Workspace Switching ====================
  "workspace.switching_title": "MAYA",
  "workspace.switching_title_unknown": "MAYA",
  "workspace.switching_subtitle": "MAYA Enterprise AI Platform",
  ...
  "app.error.sidecar_unsupported_windows": "Sidecar MAYA is bundled on Windows when available. Falling back to PATH.",
  "app.error.install_failed": "MAYA install failed. See logs above.",
  ...
  "app.migration.unsupported": "This MAYA binary does not support `maya db migrate`. Update MAYA to >=1.2.6 or switch to bundled engine.",
  "app.migration.failed": "MAYA migration failed.",
  "app.migration.restart_failed": "Migration completed, but MAYA could not restart the local engine.",
