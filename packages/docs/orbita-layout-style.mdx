...
description: "Distilled reference for the three-pane MAYA session layout"
---

This style document distills the new Orbita session UI into reusable MAYA patterns.
