...
description: "Use MAYA invite links to prefill URL and token"
---

MAYA now supports a copyable invite link in the worker share modal.
...
2. Copy `MAYA invite link`.
3. Send the link to a teammate.
4. When they open it, MAYA pre-fills remote connect fields.
