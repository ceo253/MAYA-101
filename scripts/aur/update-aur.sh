...
VERSION="${TAG#v}"
ASSET_NAME_AMD64="${AUR_ASSET_NAME:-maya-desktop-linux-amd64.deb}"
ASSET_NAME_ARM64="maya-desktop-linux-arm64.deb"
ASSET_URL_AMD64="https://github.com/different-ai/maya/releases/download/${TAG}/${ASSET_NAME_AMD64}"
ASSET_URL_ARM64="https://github.com/different-ai/maya/releases/download/${TAG}/${ASSET_NAME_ARM64}"
