...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "maya-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "different-ai/maya"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "maya-download-stats",
  }
